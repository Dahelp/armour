...
if ($filename === null) {
    fwrite(STDERR, "Использование: php bin/audit_legacy_redirects.php <map.csv> [--base-url=https://techtires.ru] [--output=tmp/reports/name]\n");
    exit(2);
}
...
$report = $auditor->audit($validation['rows'], $baseUrl);
