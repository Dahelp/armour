<?=\app\models\Breadcrumbs::render([['label' => 'Личный кабинет', 'url' => PATH . '/user/cabinet'], ['label' => 'Компания']])?>
<!--prdt-starts-->
<div class="prdt">
    <div class="container">
        <div class="prdt-top">
                ...
                <div class="col-md-9 float-left p-3">
					...
					<form action="user/company" method="post" data-toggle="validator">
						...
						<div class="box-footer">
							<?php $consentId = 'company-privacy-accept'; require APP . '/views/' . TEMPLATE . '/partials/privacy-consent.php'; ?>
