	...
	content:[		
        {
			columns: [
				...
				[
					{
						text:'Общество с ограниченной ответственностью «Еккатрейд»',
						fontSize:14,
						alignment: 'center',
						margin:[0, 0, 0, 10]
					},
					{
						text:'Юридический адрес: 142180, Московская область, г. Подольск, мкр. Климовск, Фабричный проезд, д. 4, кабинет 316\nтел.: +7 (925) 070-77-07, e-mail: info@techtires.ru, ИНН/КПП 5074079702/507401001, ОГРН 1235000003259',
						alignment: 'center',
						fontSize:8,
						margin:[0, 0, 0, 15]
					}
