...
$fd = fopen("cron/".$viewcrons["url_download"]."", 'w+') or die("не удалось создать файл");
	...
	$category = \R::getAll("SELECT id, name, parent_id FROM `category` WHERE parent_id = '3' AND hide ='show'");
	...
	AND category.parent_id = '3' AND product.hide ='show' AND product.article != '' AND product.img != '' AND product.price !='0' AND product.stock_status_id !='0'");
