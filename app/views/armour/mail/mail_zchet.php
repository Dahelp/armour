...
<head>
    ...
    <title>Запрос счёта на оплату</title>
</head>
<body>
				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" style="width:660px;padding:20px;font-family:Tahoma, Helvetica, sans-serif;color:#212529;font-size:13px" align="center">
							<tr>
								<td colspan="4" style="padding:20px 0 20px 0">На сайт <?=$namecomp?> поступил запрос счёта на оплату.<br><br>
									<b>Название товара:</b> <?=$name_tovar?><br>
									<b>Ф.И.О.:</b> <?=$fio_modal?><br>
									<b>Номер телефона:</b> <?=$tell_modal?><br>
									<b>E-mail:</b> <?=$email_modal?><br>
									<b>Комментарий:</b> <?=$prim_modal?><br>
