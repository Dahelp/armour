...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": сортировать по возрастанию",sSortDescending:": сортировать по убыванию"},oPaginate:{sFirst:"«",sLast:"»",
sNext:">",sPrevious:"<"},sEmptyTable:"Данные в таблице отсутствуют",sInfo:"Показано: с _START_ по _END_ из _TOTAL_ позиций",sInfoEmpty:"Показано: с 0 по 0 из 0 позиций",sInfoFiltered:"(поиск из: _MAX_ позиций)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать по: _MENU_ позиций",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не найдено совпадающих записей"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
