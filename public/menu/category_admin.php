...
if(!$parent){
    ...
    $delete = '<i class="fas fa-fw fa-close"></i>';
}
?>
<tr class="cont_td_znach">
	...
	<td><a href="<?=ADMIN;?>/category/edit?id=<?=$id;?>"><i class="fas fa-pencil-alt"></i></a> <?=$delete;?> <a target="_blank" href="/<?=$category['alias'];?>"><i class="fas fa-eye"></i></a></td>
</tr>
<?php if($parent): ?>
